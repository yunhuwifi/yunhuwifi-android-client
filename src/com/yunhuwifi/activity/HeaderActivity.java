...
public class HeaderActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public static interface OperateAvailableListener { 
	     public void operateAvailable();  
	     public void operateUnavailable(); 
	 } 
	    
	 private OperateAvailableListener operateAvailableListener; 
	...
	public OperateAvailableListener getOperateAvailableListener() {
		return operateAvailableListener;
	}

	public void setOperateAvailableListener(OperateAvailableListener operateAvailableListener) {
		this.operateAvailableListener = operateAvailableListener;
	}
