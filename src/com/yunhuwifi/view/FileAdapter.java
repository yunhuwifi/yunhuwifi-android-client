...
public class FileAdapter extends BaseAdapter{
    ...
    public FileAdapter(Context context,ArrayList<String> na,ArrayList<String> pa){
        names = na;
        paths = pa;
        directory = BitmapFactory.decodeResource(context.getResources(),R.drawable.fileicon);
        file = BitmapFactory.decodeResource(context.getResources(),R.drawable.launcher);
        //缩小图片
