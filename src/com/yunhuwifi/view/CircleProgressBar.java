...
public class CircleProgressBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.testspeedpbbg)); // 设置画笔颜色
		...
		canvas.drawArc(oval, -90, ((float) progress / maxProgress) * 360, false, paint); // 绘制进度圆弧，蓝色
	 ...
	 * 非ＵＩ线程调用
	 */
	public void setProgressNotInUiThread(int progress,String txt) {
		this.txt=txt;
		this.progress = progress;
		this.postInvalidate();
	}
