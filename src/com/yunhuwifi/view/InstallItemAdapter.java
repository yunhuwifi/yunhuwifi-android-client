...
public class InstallItemAdapter extends BaseAdapter {

	private List<InstallItem> menus;
	private LayoutInflater inflater;
	private int margin;

	public InstallItemAdapter(Context context, List<InstallItem> menus, int margin) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.gridview_item_installapp, parent, false);
		...
		InstallItem item = menus.get(position);
