...
public class ListViewAdapter extends BaseAdapter { 
	...
	private ListViewItemViewHolder holder = new ListViewItemViewHolder();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		ListViewItemViewHolder holder=null;
		if (convertView == null) {
			switch(switchType){
			...
			case 6:
					...
					holder.pbView=(ProgressBar) convertView.findViewById(R.id.pbnotinstall);
